...
function Dark_Yellow(scalingRatio){
	
	this.soundArray = [
		"sounds/industrial_clatter_1.ogg",
		"sounds/industrial_clatter_2.ogg",
		"sounds/mechanical_1.ogg",
		"sounds/mechanical_2.ogg",
		"sounds/mechanical_3.ogg",
		"sounds/mechanical_4.ogg",
		"sounds/mechanical_5.ogg"
		];
	this.sound;
	...
	this.imageReference = "images/colours/dark_yellow.png";
