...
function Green(scalingRatio){
	
	this.soundArray = [
		"sounds/long_guitar_note_1.ogg",
		"sounds/long_guitar_note_2.ogg",
		"sounds/long_guitar_note_3.ogg"
		];
	this.sound;
	...
	this.imageReference = "images/colours/green.png";
