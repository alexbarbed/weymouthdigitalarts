...
function Creak(scalingRatio){
	
	this.soundArray = [
		"sounds/creak_1.ogg",
		"sounds/H109_Dumpling.ogg",
		"sounds/Lazer_dub.ogg",
		"sounds/OBwan_bend.ogg",
		"sounds/piano_dischord_1.ogg"
		];
	this.sound;
	...
	this.imageReference = "images/colours/blue.png";
