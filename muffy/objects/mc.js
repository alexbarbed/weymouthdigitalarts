...
function MC(scalingRatio){
	
	this.soundArray = [
		"sounds/patter_tone_1.ogg",
		"sounds/patter_tone_2.ogg",
		"sounds/perc_pluck_1.ogg",
		"sounds/perc_pluck_2.ogg",
		"sounds/perc_pluck_3.ogg",
		"sounds/perc_pluck_4.ogg"
		];
	this.sound;
	...
	this.imageReference = "images/colours/mc.png";
