...
function Bright_Red(scalingRatio){
	
	this.soundArray = [
		"sounds/Pong_Sleigh_1.ogg",
		"sounds/Pong_Sleigh_2.ogg",
		"sounds/Radar_Pong.ogg",
		"sounds/Radio_Luxembourg.ogg",
		//"sounds/Schaeffer_Cannonball.ogg",
		"sounds/singing.ogg"
		];
	this.sound;
	...
	this.imageReference = "images/colours/bright_red.png";
